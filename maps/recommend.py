...
def group_by_centroid(restaurants, centroids):
    ...
    """
    return group_by_first([[find_closest(restaurant_location(restauraunt),centroids),restauraunt] for restauraunt in restaurants])
...
def find_centroid(cluster):
    ...
    return [mean(i) for i in zip(*[restaurant_location(restaurant) for restaurant in cluster])]
...
def rate_all(user, restaurants, feature_fns):
    ...
    for restauraunt in restaurants:
        if restauraunt in reviewed:
            d[restaurant_name(restauraunt)] = user_rating(user,restaurant_name(restauraunt))
        else:
            d[restaurant_name(restauraunt)] = predictor(restauraunt)
    return d
